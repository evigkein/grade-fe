...
import { InputModule } from '../../../forms/controls/input/input.module';
import { PhoneMaskDirective } from '../../../forms/directives/masks/phone-mask.directive';
import { isControlInvalid } from '../../../forms/utils/is-control-valid';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, InputModule, PhoneMaskDirective, RussianNumberMaskDirective, ButtonComponent, TranslatePipe]
})
